...
var ListItem = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  ...
  (0, _watchProp.watchProp)(swipeoutOpened, function (newValue) {
    if (!swipeout || !elRef.current || !_f.f7) return;

    if (newValue) {
      _f.f7.swipeout.open(elRef.current);
    } else {
      _f.f7.swipeout.close(elRef.current);
    }
  });
  ...
  if (!listIsSimple) {
    // Item Content
    itemContentEl = /*#__PURE__*/_react.default.createElement(_listItemContent.default, _extends({}, props, {
      slots: slots,
      onChange: onChange,
    ...
    if (link || href || accordionItem || smartSelect) {
      ...
      linkEl = /*#__PURE__*/_react.default.createElement("a", _extends({
        ref: linkElRef,
