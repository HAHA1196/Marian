...
(fotoramaVersion = "4.6.4"),
    (function (a, b, c, d, e) {
        ...
        function h(a, b, c) {
            return Math.max(
                isNaN(b) ? -1 / 0 : b,
                Math.min(isNaN(c) ? 1 / 0 : c, a)
            );
        }
        function i(a) {
            return (
                a.match(/ma/) && a.match(/-?\d+(?!d)/g)[a.match(/3d/) ? 12 : 4]
            );
        }
        function j(a) {
            return Ic
        ...
        function k(a) {
            ...
            return (
                Ic
                    ? (b.transform = "translate3d(" + a + "px,0,0)")
                    : (b.left = a),
                b
            );
        }
        ...
        function v(a, b) {
            if (a.length) {
                var c = a.data();
                Ic
                    ? (a.css(l(0)), (c.onEndFn = g), clearTimeout(c.tT))
                    : a.stop();
                var d = w(b, function () {
                    return j(a);
                });
        ...
        function y() {
            return (
                (y.p =
                    y.p || ("https:" === c.protocol ? "https://" : "http://")),
                y.p
            );
        }
        function z(a) {
        ...
        function B(a, b, c) {
            ...
            return (
                "youtube" === g.type
                    ? ((f =
                          y() + "img.youtube.com/vi/" + g.id + "/default.jpg"),
            ...
            function c(a, b, c) {
                ...
                d.extend(c, {
                    ...
                    thumbratio: S(
                        c.thumbratio ||
                            n(
                                c.thumbwidth || (b && b.attr("width")) || e || f
                            ) /
                                n(
                                    c.thumbheight ||
                                        (b && b.attr("height")) ||
                ...
                a.children().each(function () {
                    ...
                    if (a.is("a, img")) b(a, f, !0);
                        ...
                        c(
                            a,
                            null,
                            d.extend(f, { html: this, _html: a.html() })
                        );
                    }
                    e.push(f);
                }),
        ...
        function cb(a, c) {
                ...
                return (
                    ...
                    (p = c.select && m.is(c.select, t))
                        ...
                        : ((o = "touchstart" === a.type),
                          ...
                          (n = u.control),
                          (r =
                              u.noMove || u.noSwipe || n ? 16 : u.snap ? 0 : 4),
                          bb(a),
                          (l = ed = a),
                          (fd = a.type
            ...
            function f(a) {
                ...
                o && !u.checked
                    ...
                    !s &&
                        Math.sqrt(Math.pow(b, 2) + Math.pow(d, 2)) > r &&
                        (s = !0),
        ...
        function db(a, b) {
            ...
            return (D = d.extend(
                cb(
                    b.$wrap,
                    d.extend({}, b, { onStart: e, onMove: f, onEnd: i })
                ),
                D
            ));
        }
        ...
        !(function (a, b) {
            ...
            var m,
                ...
                p = (function () {
                    ...
                    return (
                        c(b.getElementsByTagName("head")[0], d),
                        ...
                        function f(b, c) {
                            return g(a(), {
                                ...
                                transform:
                                    ...
                                    "px,0)",
                                borderRadius:
                                    ((e.corners * e.width) >> 1) + "px",
                            });
                        }
                        for (
                            var h,
                                i = 0,
                                k = ((e.lines - 1) * (1 - e.direction)) / 2;
                            i < e.lines;
                            i++
                        )
                            (h = g(a(), {
            ...
            return (
                !f(r, "transform") && r.adj ? l() : (m = f(r, "animation")), k
            );
        });
        var Cc,
            Dc,
        ...
        (jQuery.Fotorama = function (a, e) {
            ...
            function u() {
                ...
                (ie.options = e = R(e)),
                    (Sd =
                        "crossfade" === e.transition ||
                        "dissolve" === e.transition),
                    (Md =
                        e.loop && (zd > 2 || (Sd && (!Wd || "slide" !== Wd)))),
                        ...
                        "stage" === b
                            ? (e.html &&
                                  d('<div class="' + kc + '"></div>')
                                      ...
                                      .appendTo(f),
                              e.caption &&
                                  d(N(oc, N(pc, e.caption))).appendTo(f),
            ...
            function jd() {
                if ((clearTimeout(jd.t), G.stop(jd.w), !e.autoplay || ce))
                    return void (
                        ie.autoplay && ((ie.autoplay = !1), fd("stopautoplay"))
                    );
            ...
            (qe[Xc] = d(N(yb))),
                ...
                (ie.toggleFullScreen = function () {
                    return ie[
                        (ie.fullScreen ? "cancel" : "request") + "FullScreen"
                    ]();
                }),
